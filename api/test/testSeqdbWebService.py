...
class TestSeqdbWebService(unittest.TestCase):
    ...
    def testGetSequenceIds(self):
        ...
        self.assertIn(358301, actual, "Sequence id 358301 is not expected to be associated with specimen 4405, since it is consensus.")  
    ...
    def testCreateDeleteChromatSequence(self):
        ...
        # Delete
        delete_jsn_resp = self.fixture.deleteSequence(seq_id)
